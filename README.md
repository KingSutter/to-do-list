...
NOTE: If you would prefer to skip the installation onto your local machine and just try it out, head to the app's deployed version [here](https://weekend-to-do-list-will.herokuapp.com/).
